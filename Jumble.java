  ...
  * File Name: Jumble.java
  * Teacher: Mr.Juzkiw
  * School: Philip Pocock Catholic School
  * Description: This is the class that has all the methods including the code for the GUI, to make the JUMBLE game work.
  * User is presented with an input box and a scrambled/jumbled word; and the user must guess the UNSCRAMBLED word.
  * The user wins if they get through all 40+ words without making more than 3 incorrect guesses or skipping more than 3 words. 
...
errorAlert.setText("Errors: " + errors);
    ...
    if(errors > 3){//this will close the program if the user has made more than 3 mistakes
